...
class ScanProgressScreen(Screen):
    ...
    def build(self) -> None:
        ...
        self.heading = Heading(top, "Scanning...", "")
        ...
        self.chip_scanned = StatChip(stats, "Scanned")
        self.chip_total = StatChip(stats, "Total")
        self.chip_found = StatChip(stats, "Files found")
        self.chip_eta = StatChip(stats, "Est. remaining")
        ...
        self.types_lbl = ctk.CTkLabel(self, text="Detected types: -", font=theme.font(12),
        ...
        ctk.CTkLabel(logcard, text="Activity log", font=theme.font(13, "bold")).pack(
        ...
        self.pause_btn = ghost_button(nav, "Pause", self._toggle_pause, width=130)
        self.pause_btn.pack(side="left")
        self.stop_btn = ghost_button(nav, "Stop", self._stop, width=130,
                                     text_color=theme.DANGER)
        self.stop_btn.pack(side="left", padx=10)
        self.results_btn = primary_button(nav, "View Results >", lambda: self.app.show("results"),
    ...
    def on_show(self) -> None:
        ...
        if not sc:
            return
        self.heading.winfo_children()[0].configure(text=MODE_LABELS.get(sc.config.mode, "Scanning..."))
        self._log_len = 0
    ...
    def _poll(self) -> None:
        ...
        if p.type_counts:
            ...
            self.types_lbl.configure(text="Detected types: " +
